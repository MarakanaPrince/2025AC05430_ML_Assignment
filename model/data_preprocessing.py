...
print(f"Monday data shape: {monday.shape}", f"Friday data shape: {friday.shape}")
...
drop_cls = ["Flow ID", "Source IP", " Source IP", "Src IP",
...
benign_sample = monday[monday["Target"] == 0].sample(n = 600, random_state = RANDOM_SEED)
